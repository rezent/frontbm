<script lang="ts">
  ...
  import { isValidEmail, isValidPhone } from '@shared/lib/helpers';
...
{#if isOpen}
  ...
  >
    <div
      class="relative w-full max-w-md bg-white rounded-2xl shadow-2xl animate-in fade-in-0 zoom-in-95 duration-300"
    >
      <!-- Закрытие -->
      <button
        on:click={closeModal}
          ...
          <form on:submit|preventDefault={handleSubmit} class="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 {errors.name
            ...
            <div class="space-y-4">
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 {errors.phone
                    ? 'border-red-300 bg-red-50'
                    : ''}"
                  disabled={isSubmitting}
                />
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 {errors.email
                    ? 'border-red-300 bg-red-50'
                    : ''}"
                  disabled={isSubmitting}
                />
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4">
              ...
              <button
                type="submit"
                class="flex-1 bg-gradient-to-r from-sky-700 to-sky-800 hover:from-sky-800 hover:to-sky-900 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={isSubmitting}
              >
                {#if isSubmitting}
