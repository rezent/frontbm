  ...
  <div class="bg-gradient-to-r from-sky-600 to-sky-700 text-white rounded-lg p-8 mb-12">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <p class="text-xl md:text-2xl mb-8">
        ООО «Трейд ОФ» - ведущий российский производитель оборудования для микрофильтрации
      </p>
      ...
      <div class="grid md:grid-cols-2 gap-8 items-center">
        <div>
          <p class="text-lg text-gray-700 mb-6">
            ООО «Трейд ОФ» - российский производитель современных, качественных фильтроэлементов, 
