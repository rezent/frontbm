  ...
  const certificates = [
    {
      ...
      bigImage: '/img/certificate-img-1-big.jpg',
      title: 'Сертификат соответствия № 1262326',
    },
    {
      id: 2,
      image: '/img/certificate-img-2.jpg',
      bigImage: '/img/certificate-img-2-big.jpg',
      title: 'Приложение № 0000000',
    },
    {
      id: 3,
      image: '/img/certificate-img-3.jpg',
      bigImage: '/img/certificate-img-3-big.jpg',
      title: 'Приложение № 0000000',
    },
    {
      id: 4,
      image: '/img/certificate-img-4.jpg',
      bigImage: '/img/certificate-img-4-big.jpg',
      title: 'Приложение № 0000000',
    },
    {
      id: 5,
      image: '/img/certificate-img-5.jpg',
      bigImage: '/img/certificate-img-5-big.jpg',
      title: 'Приложение № 0000000',
    },
  ];
  ...
  const articles = [
    {
      ...
      description:
        'Представляют собой соединительные элементы, которые обеспечивают надежное соединение трубопроводов.',
      image: '/img/main-catalog-img-3.jpg',
      date: "5 июня'16",
    },
    {
          ...
          {#each catalogItems as item}
            ...
            >
              <div class="relative">
                ...
                <div
                  class="absolute top-4 right-4 bg-sky-600 text-white px-3 py-1 rounded-full text-sm font-medium"
                >
                  {item.count} шт.
                </div>
              </div>
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
      <p class="text-gray-600 mb-6">
        Наши фильтры прошли строгую сертификацию. Далее некий текст..Именно таким мы создали наш
        интернет-магазин, территориально мы находимся в Обнинске, но доставляем заказы по всей
        России.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
      {#each advantages as advantage}
        <div class="text-center">
          <div
            class="bg-sky-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"
          >
...
<section class="py-16">
  <div class="container mx-auto px-4">
    <div class="flex items-center justify-between mb-8">
      ...
      <a href="/catalog" class="text-gray-600 hover:text-gray-700 font-medium"> Все товары → </a>
    </div>
...
<section class="bg-gray-50 py-16">
  <div class="container mx-auto px-4">
    <div class="flex items-center justify-between mb-8">
      ...
      <a href="/articles" class="text-gray-600 hover:text-gray-700 font-medium"> Все статьи → </a>
    </div>
    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <div class="prose prose-lg max-w-none text-gray-600">
          <p class="mb-4">
            Беспрецедентное качество, не уступает зарубежными производителями. Так же в линейке
            товаров присутствуют ПОЛНЫЕ аналоги таких зарубежных фирм как: PALL, Sartarious,
            Millipore и множество других фирм. Наша компания гарантирует Вам качество и соответствие
            всем техническим требованиям нашего продукта. Товар сертифицирован. Любой, правильно
            подобранный фильтроэлемент, фильтродержатель или фильтрационная установка решит вашу
            задачу на 110%. Более 100 компаний партнеров, которые возложили на нас решение своих
            фильтрационных задач, остались довольны нашими товарами и услугами и стали постоянными
            клиентами. Дорожа своей репутацией ООО «БМ ФИЛЬТР» точно выполняет обязательства перед
            клиентами.
          </p>

          <p class="mb-4">
            Зачем переплачивать, если можно экономить до 40% Вашего бюджета с нами, получая
            фильтроэлементы, фильтродержатели, фильтрационные установки и комплектующие отличного
            качества, для решения Ваших фильтрационных задач?
          </p>

          <p>
            ООО «БМ ФИЛЬТР» и ИП Багдасаров М.А. - молодые компании, основанные в 2015 году, но не
            смотря на юный возраст, наши знания и производство основываются на опыте известного
            российского производителя фильтрационного оборудования ООО «Экспресс-Эко», основанного в
            1991 года. Основатели компании - соавторы уникальных разработок в технологии
            производства фильтрующих элементов и фильтрационного оборудования.. <a
              href="/about"
              class="text-gray-600 hover:text-gray-700">читать далее</a
            >
          </p>
        </div>
      </div>
