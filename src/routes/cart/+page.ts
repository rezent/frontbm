...
export const load: PageLoad = () => {
  return {
    page: {
      ...
      description: 'Корзина покупок оборудования для микрофильтрации. Оформите заказ фильтроэлементов, фильтродержателей и фильтрационных установок с доставкой по всей России.',
