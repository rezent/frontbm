  ...
  <div class="max-w-6xl mx-auto">
      ...
      <div>
        ...
        <div class="space-y-8">
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <div class="space-y-2">
                <div>
                  <a href="tel:+78007008573" class="text-lg text-primary-600 hover:text-primary-700 font-semibold">
                    +7 (800) 700-85-73
                  </a>
                  <div class="text-sm text-gray-600">Бесплатный звонок по России</div>
                </div>
                <div>
                  <a href="tel:+74957971337" class="text-lg text-primary-600 hover:text-primary-700 font-semibold">
                    +7 (495) 797-13-37
                  </a>
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <a href="mailto:info@tradeof.ru" class="text-lg text-primary-600 hover:text-primary-700 font-semibold">
                info@tradeof.ru
              </a>
        ...
        <div class="mt-12">
          ...
          <div class="flex space-x-4">
            <a href="https://vk.com/tradeof" target="_blank" rel="noopener noreferrer" 
               class="bg-blue-600 text-white p-3 rounded-lg hover:bg-blue-700 transition-colors">
              VK
            </a>
            <a href="https://t.me/tradeof" target="_blank" rel="noopener noreferrer"
    ...
    <div class="mt-16">
      ...
      <div class="bg-gray-100 rounded-lg p-8">
        <img 
          src="/img/map.png" 
          alt="Карта расположения ООО «Трейд ОФ»" 
