...
export const load: PageLoad = () => {
  return {
    page: {
      ...
      description: 'Сертификаты качества и соответствия на фильтроэлементы, фильтродержатели и фильтрационные установки ООО «БМ ФИЛЬТР». Соответствие международным стандартам.',
