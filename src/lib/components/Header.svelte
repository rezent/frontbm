<script lang="ts">
	...
	function getOptionName(item: CartItem, optionType: string): string {
		...
		const option = item.options[optionType]?.find(
			(opt) => opt.id === optionId,
		);
							...
							>
								<div class="px-6 pb-4 border-b border-gray-100">
									...
									<p class="text-sm text-gray-500 mt-1">
										Профессиональные решения фильтрации
									</p>
								</div>
								<div class="px-6 py-4 grid grid-cols-1 gap-2">
									...
									>
										...
										<div class="flex-1">
											<div
												class="font-semibold text-gray-900 group-hover:text-gray-700"
											>
												Фильтроэлементы
											</div>
											<div class="text-sm text-gray-500">
												Аналоги PALL, Atlas Copco,
												собственного производства
											</div>
											<div
												class="text-xs text-gray-600 font-medium mt-1"
											>
												5 позиций
											</div>
										</div>
					...
					>
						...
						{#if showCartDropdown && $cartCount > 0}
							...
							>
								<!-- Header -->
								<div
									class="px-6 py-4 border-b border-gray-100 bg-gray-50/50"
								>
									<div
								...
								<div class="max-h-80 overflow-y-auto">
											...
											<div class="flex-1 min-w-0">
												...
												>
													...
													>
														...
														<span
															class="text-sm font-medium text-gray-900 min-w-[20px] text-center"
															>{item.quantity}</span
														>
														<button
															on:click|stopPropagation={() =>
									...
									{#if $cart.length > 5}
										<div
											class="px-4 py-3 text-center text-sm text-gray-500 bg-gray-50 border-t"
										>
											и ещё {$cart.length - 5}
											{$cart.length - 5 === 1
												? "товар"
...
<CallbackModal
	...
	on:close={modalActions.closeCallbackModal}
/>
