 ...
 */
export function generateItemListSchema(products: Product[], site: SiteInfo): Record<string, unknown> {
  return {
    "@context": "https://schema.org",
    "@type": "ItemList",
 ...
 */
export function generateBreadcrumbSchema(breadcrumbs: Breadcrumb[], site: SiteInfo): Record<string, unknown> {
  return {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
